...
DBApp.controller("departmentModifyEditorCtrl", ['$scope', '$window','dbImService' ,'$modalInstance','dept','$timeout', function($scope,$window,dbImService,$modalInstance,dept,$timeout){
    //!!FORM--START!!
    $scope.dbForm = {
    ...
    //临时解决编辑按钮不出现的问题
    $timeout(function(){
        $scope.dbForm.setOriginData(dept);
    },500);
