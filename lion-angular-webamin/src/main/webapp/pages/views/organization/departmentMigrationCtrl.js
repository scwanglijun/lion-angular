...
function DepartmentMigrationCtrl($scope,$window,dbImService,$modal) {
    ...
    $scope.dbForm = {
        ...
        sections: [{
            ...
            fields: [
                {name: "orgNamePath",label: "要迁移的机构", type: "orgTree", required: true, placeholder: "请选择要迁移的部门"},
                {name: "orgNamePath2",label: "迁入到的机构", type: "orgTree", required: true, placeholder: "请选择要迁入到的部门"}
            ]
        }]
    };
    //!!FORM-END!!
