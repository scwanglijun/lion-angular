...
DBApp.controller("groupAuthRolerCtrl", ['$scope','$modal', 'dbUtils', groupAuthRolerCtrl]);

//显示数据
function groupAuthRolerCtrl($scope,$modal,dbUtils){
    ...
    var formGridOptions = {
        ...
        grid: {
            settings: {
                transCode: "system.usergroup.authrole",
                autoLoad: true,
                page: {pageSize: 3},
                showCheckBox: false
            },
