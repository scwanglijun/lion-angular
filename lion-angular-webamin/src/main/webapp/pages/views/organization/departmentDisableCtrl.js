...
DBApp.controller("departmentDisableCtrl", ['$scope', '$window','dbImService' ,'$modal', DepartmentDisableCtrl]);

function DepartmentDisableCtrl($scope,$window,dbImService,$modal) {
    ...
    var formGridEvents = {
        grid: {
            operationEvents: [
                {name: "停用", class: "btn-danger", icon: "luru",
                    click: function (row) {
                        //TODO
                    }
                }
