...
/**
 * Created by lixiaohao on 2016/3/28.
 */
public class DataColumnExportReq extends QueryReq{

    private String tableId;
    private String excelSort;
    private  String excelOrder;
    private Long id;
    ...
    public String getExcelSort() {
        return excelSort;
    }

    public void setExcelSort(String excelSort) {
