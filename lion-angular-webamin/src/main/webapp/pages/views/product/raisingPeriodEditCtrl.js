...
DBApp.controller("raisingPeriodEditCtrl", ['$scope', '$modal', '$modalInstance', 'source', RaisingPeriodEditCtrl]);

function RaisingPeriodEditCtrl($scope, $modal, $modalInstance, source) {
    //!!FORM--START!!
    $scope.dbForm = {
