...
DBApp.controller("addUserGroupCtrl", ['$scope','$modal', 'dbUtils', addUserGroupCtrl]);

//显示数据
function addUserGroupCtrl($scope,$modal,dbUtils){
    ...
    var formGridOptions = {
        ...
        grid: {
            settings: {
                transCode: "system.usergroup.authUserCtrl",
                autoLoad: true,
                page: {pageSize: 3},
                showCheckBox: true
            },
    ...
    $scope.submitDialog = function () {
        ...
        console.log(reqBody);
        dbUtils.post('system.usergroup.authRoleRoleCtrl',reqBody,function (data) {
